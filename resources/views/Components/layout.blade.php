...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark flex-sm-row justify-content-between">
        <div style="margin-left: 10px">
            <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="" style="height: 45px; width:50px ">
            <a class="navbar-brand ps-3" href="index.html">Manipay Hindu College</a>
        </div>
        <!-- Navbar Brand-->
        <!-- Sidebar Toggle-->
        <button style="margin-left: 10px" class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i
